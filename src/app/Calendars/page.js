...
const Page = () => {
  ...
  const calendarsProducts = products.filter((product) => product.type === "calendar");

  return (
    <main className="bg-[#fffdf5] min-h-screen font-orangegummy tracking-[1.1px] py-12 px-6 md:px-20">
      <h1 className="text-2xl md:text-3xl text-yellow-600  tracking-[1.1px] text-center mb-12">
        Calendars
      </h1>
